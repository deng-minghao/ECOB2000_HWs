...
```
Team: Kseniia Minghao Deng Joe

When looking at the data, one thing I noticed is that certain people make "negative income" and certain people make more than 2 I want to exclude extreme cases by looking at people who are making incomes somewhere in between. I also want to only consider people who can work full time (adults and not retired) and people who are working full time.
